...
$prg = query("SELECT * FROM karya_pengarang WHERE id = $id ")[0];
...
<head>
    ...
    <head>
        <title>Perpustakaan | Edit Karya Pengarang</title>
    ...
    <?php if (isset($true)) : ?>
        <script>
            Swal.fire({
                ...
                window.location = "halaman-karya-pengarang.php";
            })
        </script>
    <?php endif; ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-7 mb-5">
                    <h2 style="font-weight: bold;  margin-top: 60px; text-align: center; margin-bottom: 40px;">EDIT DATA KARYA PENGARANG</h2>
                    ...
                    <form action="" method="GET" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea" name="karya_pengarang"><?= $prg["karya_pengarang"]; ?></textarea>

                        </div>

                        <button type="submit" class="btn btn-primary" name="edit">Edit Data</button>
                        <a href="halaman-karya-pengarang.php" class="btn btn-danger">Kembali</a>
                    </form>
