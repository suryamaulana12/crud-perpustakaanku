                        ...
                        <table class="table col-12 text-center justify-content-center">
                            ...
                            <?php foreach ($pnb as $row) : ?>
                                <tbody class="table-striped">
                                    ...
                                    <td><?= $row["no_telp"]; ?></td>
                                    <td>
                                        <a href="edit-penerbit.php?id= <?= $row["id"]; ?>"><button type="submit" class="btn btn-primary" style="margin-right: 5px;"><i class="bi bi-pencil-square"></i></button></a>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    ...
                    window.location = "hapus-penerbit.php?id=<?= $_GET['id']; ?>";
                })
            }
        })
    </script>
