            ...
            <table class="table col-12 text-center justify-content-center">
              ...
              <?php foreach ($buku as $row) : ?>
                <tbody class="table-striped">
                  ...
                  <td>
                    <a href="edit-buku.php?id= <?= $row["id"]; ?>"><button type="submit" class="btn btn-primary" style="margin-right: 5px;"><i class="bi bi-pencil-square"></i></button></a>
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        Swal.fire({
          ...
          window.location = "hapus-buku.php?id=<?= $_GET['id']; ?>";
        })
      }
    })
  </script>
